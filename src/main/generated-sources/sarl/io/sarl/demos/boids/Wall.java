...
public class Wall extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    if ((_size > 4)) {
      ...
      if ((_get_2 instanceof WallParameters)) {
        Object _get_3 = occurrence.parameters[1];
        this.parameters = ((WallParameters) _get_3);
      }
    }
  }
  ...
  @SyntheticMember
  public Wall(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public Wall(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public Wall(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
    super(parentID, agentID, skillProvider);
  }
  
  @Pure
  protected WallParameters getParameters() {
    return this.parameters;
  }
  
  protected void setParameters(final WallParameters parameters) {
